...
class TheBoss(Character):
    ...
    def __init__(self,x,y):
        ...
        self.ypos = y
        self.movespeed = 4
        self.health = 130  *(len(players))
        self.maxhealth = 130 * (len(players))
        self.strength = 12
...
playlist = ['Music/mapoftheproblematique.ogg', 'Music/uprising.ogg',
            'Music/hysteria.ogg', 'Music/sunburn.ogg',  'Music/hypnotize.ogg', 'Music/chopsuey.ogg',
...
injury_playlist = ['Music/injury.ogg',  'Music/ouch.ogg',
                   ...
                   'Music/myarm.ogg', 'Music/timeout.ogg' 'Music/alive.ogg'
                   'Music/die.ogg', 'Music/children.ogg']
    ...
    if game_start:
        ...
        if not game_pause:
            ...
            for n in range(1,5):
                ...
                if game_seconds < n * 30 and game_seconds > (n * 30 - 15):
                    robotcount = 0
                ...
                if bossPlayed == True and not robots:
                    text = font.render("You Win!", True, WHITE)
                    textRect = text.get_rect()
                    textRect.centerx = windowSurface.get_rect().centerx
                    textRect.centery = windowSurface.get_rect().centery + messageFontsize
                    messages.append(screenMessage(text, textRect, 100))
                    bossPlayed = False #Change later, doesn't make sense
                 ...
                 #   game_pause = False
                  ...
                  #  pygame.mixer.music.fadeout(5000)
                   ...
                   # game_over_text = messageFont.render('YOU WON!   TOTAL SCORE: %d' %(total_score), True, WHITE, BLACK)
